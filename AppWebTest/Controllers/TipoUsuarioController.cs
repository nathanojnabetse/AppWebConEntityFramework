...
namespace AppWebTest.Controllers
{
    ...
    {
        private TipoUsuarioCLS oTipoVal; //almacena el modelo que recibimos de la vista
        ...
        public ActionResult Index(TipoUsuarioCLS oTipoUsuario)
        {
            ...
            using (var bd = new BDPasajeEntities())
            {
                ...
                else
                {
                    ...
                    listaFiltrado = listaTipoUsuario.FindAll(pred);//recorre cada elemento de la lista y se evalua por el predicado
                }
            }
